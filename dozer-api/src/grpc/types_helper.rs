...
pub fn map_insert_operation(table_name: String, record: CacheRecord) -> Operation {
    Operation {
...
pub fn map_delete_operation(table_name: String, record: CacheRecord) -> Operation {
    Operation {
...
pub fn map_update_operation(table_name: String, old: CacheRecord, new: CacheRecord) -> Operation {
    Operation {
