...
#[test]
fn test_serialize_filter_simple() -> anyhow::Result<()> {
...
#[test]
fn test_serialize_filter_complex() -> anyhow::Result<()> {
    test_serialize_filter(
...
fn test_serialize_filter(a: Value, b: FilterExpression) -> anyhow::Result<()> {
