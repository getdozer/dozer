...
use crate::aggregation::groupby::{FieldRule, AggregationProcessor, AggregationProcessorFactory};
...
fn test_insert_update_delete() {
    ...
    let rules = vec![
        ...
        FieldRule::Measure(3, Box::new(IntegerSumAggregator::new()), true, Some("Sum".to_string()))
    ];
