use crate::execution::processor::{NodeHandle, PortHandle, ProcessorFactory, SinkFactory};
use std::collections::HashMap;
use crate::sources::subscriptions::{RelationName, SourceId, SourceName};
...
impl Dag {
    ...
    pub fn add_source(source: SourceName, relation: RelationName)
