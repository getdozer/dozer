...
use crate::error::{Error as PipelineError, OperationError};
                        ...
                        match $op {
                            "-" => {
                                let duration = left_v.0.checked_sub(right_v.0).ok_or(
                                    PipelineError::SqlError(OperationError::AdditionOverflow),
                                )?;
                                Ok(Field::from(DozerDuration(duration, TimeUnit::Nanoseconds)))
                            }
                            "+" => {
                                let duration = left_v.0.checked_add(right_v.0).ok_or(
                                    PipelineError::SqlError(OperationError::SubtractionOverflow),
                                )?;
                                Ok(Field::from(DozerDuration(duration, TimeUnit::Nanoseconds)))
                            }
                    ...
                    Field::Timestamp(right_v) => match $op {
                        "+" => {
                            let duration = right_v
                                ...
                                .ok_or(PipelineError::SqlError(OperationError::AdditionOverflow))?;
                            ...
                            "/" => {
                                if right_v == 0_i8 {
                                    ...
                                    Ok(Field::Float($fct(
                                        ...
                                        OrderedFloat::<f64>::from_i64(right_v as i64).ok_or(
                                            PipelineError::UnableToCast(
                                                format!("{}", right_v),
                                                "f64".to_string(),
                                            ),
                ...
                Field::UInt(left_v) => match right_p {
                    ...
                    Field::Int8(right_v) => {
                        return match $op {
                            ...
                            "/" => {
                                if right_v == 0_i8 {
                                    ...
                                    Ok(Field::Float(OrderedFloat($fct(
                                        ...
                                        f64::from_i64(right_v as i64).ok_or(
                                            PipelineError::UnableToCast(
                                                format!("{}", right_v),
                                                "f64".to_string(),
                                            ),
                            ...
                            // When it's not division operation
                            "+" | "-" | "*" | "%" => Ok(Field::Int(
                                $fct(Wrapping(left_v as i64), Wrapping(right_v as i64)).0,
                            )),
                            &_ => Err(PipelineError::InvalidTypeComparison(
                                left_p,
                                right_p,
                    ...
                    return match $op {
                        ...
                        "%" => {
                            match right_p {
                                ...
                                Field::Int8(right_v) => Ok(Field::Decimal(
                                    left_v
                                        .checked_rem(Decimal::from_i64(right_v as i64).ok_or(
                                            PipelineError::UnableToCast(
                                                format!("{}", left_v),
                                                "Decimal".to_string(),
                                            ),
                        ...
                        "*" => {
                            match right_p {
                                ...
                                Field::Int8(right_v) => Ok(Field::Decimal(
                                    left_v
                                        .checked_mul(Decimal::from_i64(right_v as i64).ok_or(
                                            PipelineError::UnableToCast(
                                                format!("{}", left_v),
                                                "Decimal".to_string(),
                                            ),
                        ...
                        "+" | "-" => {
                            match right_p {
                                ...
                                Field::Int8(right_v) => Ok(Field::Decimal($fct(
                                    left_v,
