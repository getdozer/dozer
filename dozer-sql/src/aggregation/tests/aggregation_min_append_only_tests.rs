...
fn test_min_aggregation_float() {
    let schema = init_input_schema(Float, "MIN_APPEND_ONLY");
    let mut processor = init_processor(
        "SELECT Country, MIN_APPEND_ONLY(Salary) \
        FROM Users \
...
fn test_min_aggregation_int() {
    let schema = init_input_schema(Int, "MIN_APPEND_ONLY");
    let mut processor = init_processor(
        "SELECT Country, MIN_APPEND_ONLY(Salary) \
        FROM Users \
        WHERE Salary >= 1 GROUP BY Country",
...
fn test_min_aggregation_uint() {
    let schema = init_input_schema(UInt, "MIN_APPEND_ONLY");
    let mut processor = init_processor(
        "SELECT Country, MIN_APPEND_ONLY(Salary) \
        FROM Users \
        WHERE Salary >= 1 GROUP BY Country",
...
fn test_min_aggregation_decimal() {
    let schema = init_input_schema(Decimal, "MIN_APPEND_ONLY");
    let mut processor = init_processor(
        "SELECT Country, MIN_APPEND_ONLY(Salary) \
        FROM Users \
        WHERE Salary >= 1 GROUP BY Country",
...
fn test_min_aggregation_duration() {
    let schema = init_input_schema(Duration, "MIN_APPEND_ONLY");
    let mut processor = init_processor(
        "SELECT Country, MIN_APPEND_ONLY(Salary) \
        FROM Users \
        WHERE Salary >= 1 GROUP BY Country",
...
fn test_min_aggregation_timestamp() {
    let schema = init_input_schema(Timestamp, "MIN_APPEND_ONLY");
    let mut processor = init_processor(
        "SELECT Country, MIN_APPEND_ONLY(Salary) \
        FROM Users \
        WHERE Salary >= 1 GROUP BY Country",
...
fn test_min_aggregation_date() {
    let schema = init_input_schema(Date, "MIN_APPEND_ONLY");
    let mut processor = init_processor(
        "SELECT Country, MIN_APPEND_ONLY(Salary) \
        FROM Users \
        WHERE Salary >= 1 GROUP BY Country",
