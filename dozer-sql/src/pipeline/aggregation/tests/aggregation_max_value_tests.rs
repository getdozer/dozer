...
fn test_max_aggregation_float() {
    let schema = init_max_val_input_schema(Float, "MAX_VALUE");
    ...
    */
    ...
    let mut exp = vec![insert_max_val_exp(&Field::String(ITALY.to_string()))];
    assert_eq!(out, exp);
    ...
    */
    ...
    out = output!(processor, inp);
    exp = vec![delete_max_val_exp(&Field::String(ITALY.to_string()))];
    assert_eq!(out, exp);
}

#[test]
fn test_max_aggregation_int() {
    let schema = init_max_val_input_schema(Int, "MAX_VALUE");
    let mut processor = init_processor(
        "SELECT MAX_VALUE(Salary, Country) FROM Users",
        HashMap::from([(DEFAULT_PORT_HANDLE, schema)]),
    )
...
fn test_max_aggregation_uint() {
    let schema = init_max_val_input_schema(UInt, "MAX_VALUE");
    let mut processor = init_processor(
        "SELECT MAX_VALUE(Salary, Country) FROM Users",
        HashMap::from([(DEFAULT_PORT_HANDLE, schema)]),
    )
...
fn test_max_aggregation_decimal() {
    let schema = init_max_val_input_schema(Decimal, "MAX_VALUE");
    let mut processor = init_processor(
        "SELECT MAX_VALUE(Salary, Country) FROM Users",
        HashMap::from([(DEFAULT_PORT_HANDLE, schema)]),
    )
...
fn test_max_aggregation_duration() {
    let schema = init_max_val_input_schema(Duration, "MAX_VALUE");
    let mut processor = init_processor(
        "SELECT MAX_VALUE(Salary, Country) FROM Users",
        HashMap::from([(DEFAULT_PORT_HANDLE, schema)]),
    )
...
fn test_max_aggregation_timestamp() {
    let schema = init_max_val_input_schema(Timestamp, "MAX_VALUE");
    let mut processor = init_processor(
        "SELECT MAX_VALUE(Salary, Country) FROM Users",
        HashMap::from([(DEFAULT_PORT_HANDLE, schema)]),
    )
...
fn test_max_aggregation_date() {
    let schema = init_max_val_input_schema(Date, "MAX_VALUE");
    let mut processor = init_processor(
        "SELECT MAX_VALUE(Salary, Country) FROM Users",
        HashMap::from([(DEFAULT_PORT_HANDLE, schema)]),
    )
...
fn test_max_aggregation_int_null() {
    ...
    */
    ...
    let mut out = output!(processor, inp);
    let mut exp = vec![insert_max_val_exp(FIELD_NULL)];
    assert_eq!(out, exp);
    ...
    */
    ...
    out = output!(processor, inp);
    exp = vec![update_max_val_exp(FIELD_NULL, FIELD_NULL)];
    assert_eq!(out, exp);
    ...
    */
    inp = delete_field(ITALY, FIELD_NULL);
    out = output!(processor, inp);
    exp = vec![delete_max_val_exp(FIELD_NULL)];
    assert_eq!(out, exp);
}
