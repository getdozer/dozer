...
use crate::pipeline::processor::preaggregation::PipelineError::InvalidExpression;
use crate::pipeline::processor::preaggregation::PipelineError::InvalidOperator;
...
pub struct PreAggregationProcessorFactory {
    statement: Vec<SelectItem>,
}

impl PreAggregationProcessorFactory {
...
impl ProcessorFactory for PreAggregationProcessorFactory {
...
pub struct PreAggregationProcessor {
    statement: Vec<SelectItem>,
    input_schema: Schema,
