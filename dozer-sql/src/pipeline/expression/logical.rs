...
pub fn evaluate_and(
    ...
    let l_field = left.evaluate(record_store, record, schema)?;
    let r_field = right.evaluate(record_store, record, schema)?;
    match l_field {
...
pub fn evaluate_or(
    ...
    match l_field {
        ...
        Field::Boolean(false) | Field::Null => {
            match right.evaluate(record_store, record, schema)? {
                Field::Boolean(false) => Ok(Field::Boolean(false)),
                Field::Boolean(true) => Ok(Field::Boolean(true)),
                Field::Null => Ok(Field::Boolean(false)),
                Field::UInt(_)
...
pub fn evaluate_not(
    ...
    let value_p = value.evaluate(record_store, record, schema)?;
